...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/docs/3.2.8/reference/html/native-image.html#native-image)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.2.8/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm caixa:0.0.1-SNAPSHOT
```
